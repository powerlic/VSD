...
typedef boost::signal<void(const char* service_id, const vector<CvRect> &reg_rects, const uint32_t dst_width, const uint32_t dst_height, const vector<float> &scores, const vector<string> &labels)>  signal_reg;
