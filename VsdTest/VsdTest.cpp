...
void TestVibeBoost();
void TestSsd(const char* ssd_model_path, const char* serivce_list_path);
...
void TestSsd(const char* ssd_model_path, const char* serivce_list_path)
{
	shared_ptr<VsdSsdMaster> ptr_demo = shared_ptr<VsdSsdMaster>(new VsdSsdMaster(ssd_model_path));
	ptr_demo->ptr_vas_ssd_->StartServicesFromProtoFile(serivce_list_path);
	while (true)
	{
		Sleep(1000);
	}
...
{
	//TestVibeBoost();
	const char* ssd_model_path = "..\\proto\\ssd_model_path.prototxt";
	const char* serivce_list_path = "..\\proto\\ssd_service_list.prototxt";
	TestSsd(ssd_model_path, serivce_list_path);
	//TestVas("..\\proto\\caffe_model_0523.prototxt", "..\\proto\\file_service_list.prototxt");
