...
extern "C" DLL_CLASSIFICATION_API Classifier* _stdcall CreateClassifier(string model_file, string trained_file, string mean_file, string label_file,bool is_useGPU);
